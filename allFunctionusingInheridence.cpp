...
#include"header.h"
void test(void) {cout<<"I am in file!!"<<'\n';}
void empDataAnalysisClass ::initialize(ifstream & indata)
{
...
/***********************************************************************/
void empDataAnalysisClass::getData(ifstream &indata)
{
...
void empDataAnalysisClass::salesByQuarter(double totalSalesByQuarter[])
{
...
void empDataAnalysisClass::salesByYearlyForEachEmploye(void)
{
...
/******************************************************************************/
void empDataAnalysisClass::printEmployeReport(ofstream & outputData,double totalSalesByQuarter[])
{
...
/*********************************************************************/
void  empDataAnalysisClass:: maxSalesByPerson(ofstream & outputFile )
{
	uint8_t maxIndex=0;
...
void  empDataAnalysisClass:: maxSalesByQuarter(ofstream & outputFile ,double maxSalesByQt[])
{
...
/*************************************************************************/
void empDataAnalysisClass::sumOfAllStack(void)
